...
LAB4 \& 5 tập trung vào thiết kế hệ thống SoC sử dụng vi xử lý Nios II kết hợp với Timer để tạo các ngắt định kỳ, phục vụ cho việc điều khiển các thiết bị ngoại vi theo thời gian thực. Sơ đồ mạch bên dưới thể hiện hệ thống được xây dựng trên Qsys/Platform Designer bao gồm Timer IP, JTAG UART, và các PIO I/O dùng để giao tiếp với Switch và điều khiển LED:

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/fig_5_1.png}
    \caption{Sơ đồ kiến trúc kết nối hệ thống Nios II với SDRAM, Timer và PIO (LAB 4 \& 5)}
\end{figure}
...
\noindent\textbf{Video demo (Exercise 1):} \url{https://drive.google.com/file/d/19Dob9vkyaeMIk0q8_X-P9wBiTI6qlxhv/view?usp=sharing}

\vspace{0.5cm}

\noindent\textbf{Video demo (Exercise 2):} \url{https://drive.google.com/file/d/1t4B46cz-S5lmfvV93O0Q81NDoJCr29YI/view?usp=sharing}
...
\noindent\textbf{Video demo Switch 1 set (Exercise 3):} \url{https://drive.google.com/file/d/1RLEf-r3jpekWmzpmbCO9pfXjf5YWErHv/view?usp=sharing}

\noindent\textbf{Video demo Switch 2 set (Exercise 3):} \url{https://drive.google.com/file/d/1-oA-4bSV5zoDjOAlGvqcHhHAtg6sV7pH/view?usp=sharing}
...
\subsection{Báo cáo kết quả Quartus synthesis implementation, resource, $f_{max}$}
Kết quả synthesis Resource và $f_{max}$ của LAB6:

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/lab6_rtl_view.jpg}
    \caption{RTL View của LAB6}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/lab6_resource.jpg}
    \caption{Tài nguyên sử dụng (Resource) của LAB6}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/lab6_fmax.jpg}
    \caption{Tần số hoạt động tối đa ($f_{max}$) của LAB6}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/lab6_result.jpg}
    \caption{Kết quả chạy test code trên console (LAB6)}
\end{figure}
