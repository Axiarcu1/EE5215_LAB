...
\subsection{Báo cáo kết quả Quartus synthesis implementation, resource, {max}$}
Kết quả synthesis Resource và {max}$ của LAB3:
...
\begin{figure}[H]
    ...
    \caption{Tần số hoạt động tối đa ({max}$) của LAB3}
\end{figure}
...
\subsection{Báo cáo kết quả Quartus synthesis implementation, resource, {max}$}
Kết quả synthesis Resource và {max}$ chung cho LAB 4 và LAB 5:
...
\begin{figure}[H]
    ...
    \caption{Tần số hoạt động tối đa ({max}$) của LAB 4-5}
\end{figure}
