...
\textit{(Sinh viên bổ sung sơ đồ mạch cho LAB 4 \& 5 tại đây)}

\subsection{Sơ đồ dataflow với code software}

\textit{(Sinh viên bổ sung sơ đồ dataflow cho LAB 4 \& 5 tại đây)}
...
\textit{(Sinh viên bổ sung sơ đồ mạch cho LAB 6 tại đây)}

\subsection{Sơ đồ dataflow với code software}

\textit{(Sinh viên bổ sung sơ đồ dataflow và mã nguồn cho LAB 6 tại đây)}

\subsection{Báo cáo kết quả Quartus synthesis implementation, resource, $f_{max}$}

\textit{(Sinh viên bổ sung kết quả tổng hợp Quartus cho LAB 6 tại đây)}

\subsection{Hình ảnh chạy test code trên console}

\textit{(Sinh viên bổ sung hình ảnh chạy test code trên console và video demo cho LAB 6 tại đây)}
